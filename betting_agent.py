...
st.set_page_config(page_title="AI Betting Agent", layout="centered", page_icon="🤖")
st.title("🤖 AI Betting Agent - พี่เอก")
st.caption("เลือกสูตรได้: Paroli 3 ขั้น หรือ 1-3-2-6 | Banker 100%")
...
# กำหนด sequence ตามสูตร
if system_choice == "Paroli 3 ขั้น (1-2-4)":
    sequence = [1, 2, 4]      # Paroli 3 ขั้น
    max_steps = 3
...
if colB.button("❌ แพ้ (L)", use_container_width=True, type="secondary"):
    ...
    st.session_state.step = 0   # รีเซ็ตเมื่อแพ้
...
st.caption("💡 แนะนำ: ใช้ร่วมกับตารางชีวิตและ mindfulness ที่เราคุยกัน เพื่อควบคุมตัวเอง")
