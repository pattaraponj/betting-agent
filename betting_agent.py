...
if system_choice == "1-2 (Paroli 2 ขั้น)":
    ...
    max_steps = 4
    system_name = "1-3-2-6"
elif system_choice == "1-1-2-4-8":
    sequence = [1, 1, 2, 4, 8]
    max_steps = 5
    system_name = "1-1-2-4-8"
else:  # Oscar’s Grind
...
# แสดงสถานะหลัก (ปรับให้แสดงทุนคงเหลือชัดเจน)
...
st.caption("💡 มี 6 สูตรให้เลือก | 1-2 แนะนำสำหรับคุณ | ปรับการแสดงเดิมพันให้เร็วขึ้นแล้ว")
